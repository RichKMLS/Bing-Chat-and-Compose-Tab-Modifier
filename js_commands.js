...
// Define an IIFE function that sets the maxLength property of the search box to 25000 if on chat.
(function() {
...
// and placeholder text of a text input element if on compose.
(function() {
